...
RSpec.describe Api::V1::ProjectsController, type: :request do
  ...
  describe 'GET index' do
    ...
    it 'returns projects', :skip_before do
      ...
      expect(body['data'][0]['attributes'].keys).to contain_exactly('description', 'id', 'name', 'current_user_role', 'current_user_role_source')
  ...
  describe 'POST create' do
    ...
    it 'creates a new project with name' do
      ...
      expect(body['data']['attributes'].keys).to contain_exactly('id', 'name', 'description', 'current_user_role', 'current_user_role_source')
