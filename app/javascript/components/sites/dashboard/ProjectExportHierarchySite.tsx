  ...
  render() {
    return (
      <Layout style={{ padding: "0 24px 24px", margin: "0", width: "100%" }}>
        ...
        <Content style={{ margin: "24px 16px 0", minHeight: 360, display: "flex", flexDirection: "column", maxWidth: 800 }}>
          <h1>Hierarchy</h1>
          <p>
            Build a hierarchy by making use of drag and drop to specify which translations should be used when there is no translation for the key available.
            If a translation is not found the hierarchy is traversed upwards until a translation has been found or the end is reached.
          </p>
